                    ...
                    <div class="idea-box">
                        <div class="idea-img">
                            ...
                            <div class="idea-box">
                                ...
                                <div class="idea-info">
                                    <div class="idea-content">
                                        <h2><a href="/community/add?wnum=${b.wnum}">${b.title}</a></h2>
                                        <p>${b.num.name}</p>
                                        <p>${b.content}</p>
                                        <p>${b.hash}</p>
                                        <p>${b.wdate}</p>
                            ...
                            <span style="padding: 5px; margin-top: 230px; border-radius:100px; border:1px; border-color: #f0f0f0;">
                                <a href="/community/edit?wnum=${b.wnum}"><button type="submit" class="cancel_button" size="10px" >수정</button></a><!--button type="button"-->
                            </span>
                                    <%--                          </c:if>--%>
