      ...
      <div>
          <div>
              ...
              <form action="/service/edit" method="post" enctype="multipart/form-data">
                <input type="hidden" value="${b.num.name}" readonly/>
                  <input type="hidden" name="wnum" value="${b.wnum}" readonly/>
                  <div class="ser-ttbox">
                      <p class="ser-title">제목</p>
                      <input class="ser_tex" name="title" type="text" value="${b.title}">
                  ...
                  <div class="ser-contbox">
                      ...
                      <textarea class="ser-area" name="content" placeholder="문의 할 게시판 내용 등을 상세하게 작성해주세요!">${b.content}</textarea>
                  </div>
