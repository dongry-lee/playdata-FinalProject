...
check out<br>
 ...
 - 진수: 투표페이지 뷰 , 투표기능 완설할줄 알았는데 생각보다 잘안되서 내일까지로<br>
...
check in<br>
 - 동근: <br>
 - 진수: 투표기능 완성후 시간이 남으면 검색 해쉬태그기능 개발 / The Walters - I Love You So<br>
 - 민서:아이디어페이지 css랑 동근님이 최신화하신 백코드랑 합쳐서 페이지 완성, 디테일페이지 댓글부분 제작 / 요즘 즐겨듣는 노래:<br>   
 - 진웅: <br>
