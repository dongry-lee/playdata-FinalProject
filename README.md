...
9/7 (수요일) 오늘의 질문 :즐겨신는 신발 브랜드가 있나요?<br>
  ...
  - 민서:자유게시판 리스트페이지,작성페이지 뷰 충돌 수정 -> 슬라이드 뷰 제작으로 뷰 전격 수정 <br>
...
- 민서: css 수정+ 슬라이드 오류 멘토님꼐 질문..+남은하루만에 모든 페이지에 css적용 똑같이 끝내야하는데..<br>
- 진웅: 발표자료 초안 작성중 CSS수정 및 고객센터 디테일 페이지 제작<br>

9/14 (수요일) D-2 이틀이 남았습니다...! 오늘의질문:수료 후 주말에 뭐할 계획이신가요?<br>
  check in<br> 
  - 동근: <br>
  - 진수:<br>
  - 민서: <br>
